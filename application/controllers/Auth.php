            ...
            if (!empty($recaptcha)) {
                ...
                if (isset($response['success']) and $response['success'] === true) {
                    ...
                    if ($this->ion_auth->login($this->input->post('identity'), $this->input->post('password'), $remember)) {
                        ...
                        $this->session->set_flashdata('message', 'sukses login');
                        redirect('/dashboard');

                    } else {
                        // if the login was un-successful
                        // redirect them back to the login page
                        $this->session->set_flashdata('message', 'gagal login periksa lagi username atau password nya');
                        redirect('auth/login');
                    }
                ...
                $this->session->set_flashdata('message', 'pass the captcha');
                redirect('auth/login');
            }
